...
# shai-novelist:v1) haven't been verified to call tools as reliably, per this
...
async def _stream_reply(
    ...
    try:
        if not tools:
            ...
            # Shai, Chai) always takes; only central's own toolset ever reaches
...
async def chat_ws(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # (knowledge_enabled: false) — Doc/Kona/Estra/Shai/Chai could never see
